...
**Background:** I'm an OTel contributor (PR merged into collector-contrib) and built this because the existing tail sampling processor has no concept of "this trace cost money." You can approximate it with OTTL conditions, but you can't aggregate cost across spans in a trace.
